...
int BAR30_init(void) { // GERİ DÖNÜŞ DEĞERİ BOOL OLARAK DEĞİŞTİRİLECEK
    ...
    if (crcCalculated != crcRead) {		//BURDA CRC KARŞILAŞTIRMASI YAPIYORUZ
        return 1;
    }
