...
static void try_to_engine(void);
...
static void try_to_engine(void)
{
    ...
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, 1400);
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 1400);
    ...
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 1700);
